Problem
-------
Tambourine has prepared a fitness program so that she can become more fit! The program is made of **N** sessions. During the i-th session, Tambourine will exercise for E = mc\ :sup:`2` minutes. The number of minutes she exercises in each session are strictly increasing.
